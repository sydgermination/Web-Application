...
<?php if(Route::has('login')): ?>
  <?php if(auth()->guard()->check()): ?>
    <li class="nav-item">
      <a class="nav-link text-dark" href="<?php echo e(url('/home')); ?>">Dashboard</a>
    </li>
  <?php else: ?>
    <li class="nav-item">
...
<section class="d-flex flex-column flex-lg-row align-items-center justify-content-between bg-light" style="min-height: 90vh;">
    ...
    <div class="col-lg-6 p-0">
        <div style="
            background: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url('<?php echo e(asset('pcu.png')); ?>') center center / cover no-repeat;
            height: 90vh;
        "></div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sydne\Desktop\FINAL FOR DEFENSE EDITING\Editing\resources\views/welcome.blade.php ENDPATH**/ ?>