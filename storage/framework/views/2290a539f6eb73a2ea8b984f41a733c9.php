...
<div class="container mt-5">
    <div class="d-flex justify-content-center mb-4">
        <a href="<?php echo e(url('event/show')); ?>" class="nav-link-animated">
            <h3 class="font-weight-bold mx-3">All Events</h3>
        </a>
        <a href="<?php echo e(url('event/create')); ?>" class="nav-link-animated">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sydne\Desktop\FINAL FOR DEFENSE EDITING\Editing\resources\views/event/create.blade.php ENDPATH**/ ?>